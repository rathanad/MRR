...
import com.avenues.lib.activity.StatusActivity;
...
public class WebViewActivity extends Activity {
	...
	public void onCreate(Bundle bundle) {
		...
		setContentView(com.avenues.lib.activity.R.layout.activity_webview);
	...
	private class RenderView extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			...
			if(!ServiceUtility.chkNull1(vResponse).equals("")
					&& ServiceUtility.chkNull1(vResponse).toString().indexOf("ERROR")==-1){
		...
		protected void onPostExecute(Void result) {
			...
			final WebView webview = (WebView) findViewById(com.avenues.lib.activity.R.id.webview);
